      ...
      <nav className="fixed w-full z-50 bg-stone-50/80 backdrop-blur-md border-b border-stone-200 px-6 md:px-12 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Link to="/#contacto" className="bg-green-800 text-stone-50 px-4 sm:px-5 py-2.5 rounded-full text-xs sm:text-sm font-medium hover:bg-green-700 transition-colors flex items-center gap-2 group whitespace-nowrap">
              {c.cta}
